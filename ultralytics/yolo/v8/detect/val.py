...
class DetectionValidator(BaseValidator):
    ...
    def __init__(self, dataloader=None, save_dir=None, pbar=None, args=None, overrides=None, _callbacks=None):
        ...
        self.iouv = torch.linspace(0.0, 0.95, 20)  # iou vector for mAP@0:0.95
    ...
    def get_stats(self):
        ...
        if len(stats) and stats[0].any():
            # stats[0] is being used here, which means to make YOLO work, the new-added IoU metric cant be appended at the beginning of stats
            self.metrics.process(*stats)
        # stats[-1] is being used here, which means to make YOLO work, the new-added IoU metric cant be appended at the end of stats
